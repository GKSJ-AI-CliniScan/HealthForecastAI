...
DERIVED = [
    ...
    "total_prior_visits", "num_med_changes", "num_meds_prescribed",
]

SAMPLE = {
    "race": "Caucasian", "gender": "Female", "age": "[70-80)",
    "time_in_hospital": 5, "num_lab_procedures": 41, "num_procedures": 0,
    "num_medications": 18, "number_outpatient": 1, "number_emergency": 2,
    "number_inpatient": 3, "number_diagnoses": 9,
    "diag_1": "250.83", "diag_2": "428", "diag_3": "V57",
    "metformin": "Up", "insulin": "Steady", "glipizide": "No",
    "glyburide": "Down", "change": "Ch", "diabetesMed": "Yes",
}
...
def test_serving_matches_training_on_every_derived_column() -> None:
    ...
    for column in DERIVED:
        assert served[column] == trained[column], (
