...
export const TreatmentsPage: React.FC = () => {
  ...
  const { data: patientsData, isLoading, isError, refetch } = useQuery({
    queryKey: ['patients-for-treatments', search],
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Therapeutic Regimens & Treatments"
        subtitle="Manage medications, dosages, clinical protocols, and therapy outcomes."
      />
      ...
      <Card className="p-4">
        <div className="relative max-w-md">
          ...
          <input
            type="text"
            placeholder="Search patient to prescribe or inspect treatments..."
      ...
      {isLoading ? (
        ...
        <ErrorAlert message="Failed to load treatment directory." onRetry={() => refetch()} />
      ) : (
        <Table>
          <TableHeader>
            <TableRow>
